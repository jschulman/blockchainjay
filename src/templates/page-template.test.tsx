...
describe("PageTemplate", () => {
  ...
  test("head renders correctly", () => {
    ...
    expect(getMeta(container, "twitter:title")).toEqual("Humane Typography in the Digital Age - Writings by Jay Schulman");
    expect(getMeta(container, "og:title")).toEqual("Humane Typography in the Digital Age - Writings by Jay Schulman");
